...
export async function primitiveEngineFixture(
  signers: Wallet[],
): Promise<PrimitiveEngineFixture> {
...
export async function primitiveFactoryFixture(
  signers: Wallet[],
): Promise<PrimitiveFactoryFixture> {
  const [deployer] = signers;
