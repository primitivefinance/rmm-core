...
interface IPrimitiveEngineEvents {
    ...
    event Deposited(address indexed from, address indexed owner, uint256 deltaX, uint256 deltaY);
    ...
    event Withdrawn(address indexed from, uint256 deltaX, uint256 deltaY);
    ...
    /// @param  deltaX  The amount of risky tokens deposited
    /// @param  deltaY  The amount of stable tokens deposited
    event Allocated(address indexed from, uint256 deltaX, uint256 deltaY);

    /// @notice Adds liquidity of risky and stable tokens to a specified curve `pid`
    /// @param  from   The calling `msg.sender`
    /// @param  deltaX  The amount of risky tokens deposited
    /// @param  deltaY  The amount of stable tokens deposited
    event Removed(address indexed from, uint256 deltaX, uint256 deltaY);
    ...
    event Loaned(address indexed from, bytes32 indexed pid, uint256 deltaL);

    /// @notice Liquidity shares removed from the float
    /// @param  from   The calling `msg.sender`
    /// @param  pid     The keccak hash of the option parameters of a curve to interact with
    /// @param  deltaL  The amount of liquidity shares removed from the float
    event Claimed(address indexed from, bytes32 indexed pid, uint256 deltaL);
    ...
    event Borrowed(address indexed recipient, bytes32 indexed pid, uint256 deltaL, uint256 maxPremium);
    ...
    event Repaid(address indexed owner, bytes32 indexed pid, uint256 deltaL);
