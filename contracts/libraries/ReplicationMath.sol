...
library ReplicationMath {
    ...
    /// @notice Returns the riskless reserve value based on a risky reserve value using the perp. put function
    ...
    /// @notice Returns the perp. put trading function invariant
