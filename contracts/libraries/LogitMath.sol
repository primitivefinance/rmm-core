...
library LogitMath {
     ...
     */
    function getTradingFunction(uint RX1, uint RY2, uint liquidity, Params memory params) internal view returns (int128 deltaY) {
     ...
     */
    function calcInvariant(uint p, int slope, int translation) internal view returns (int128 invariant) {
